...
const mainLightColor = Color(0xFFFFBB00);
const mainLightLessColor = Color(0xFFFF9100);

const mainLinearGradient =
...
//     colors: [mainLightLessColor, mainLightLessColor, mainLightColor ,mainLightColor, Color(0xffffffff)]
// );
